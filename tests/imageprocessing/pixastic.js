 ...
 */
 ...
 var Pixastic = (function() {
    ...
    function Pixastic(ctx, workerControlPath) {
		...
		var worker = new window.Worker(workerControlPath + "pixastic.worker.control.js");
    ...
    Pixastic.Worker = function() {
        ...
        function processMessage(data) {
            ...
            for (var i=0;i<queue.length;i++) {
                ...
                effects[e](inData.data, outData.data, width, height, options, progressCallback);
